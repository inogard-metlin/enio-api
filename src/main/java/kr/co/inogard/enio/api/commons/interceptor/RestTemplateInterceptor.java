...
public class RestTemplateInterceptor implements ClientHttpRequestInterceptor {
  ...
  public ClientHttpResponse intercept(HttpRequest request, byte[] body,
    ...
    String agtCd = (authentication != null) ? ((ApiUserDetailsImpl) authentication.getPrincipal()).getAgent().getAgtCd() : apiConfig.getApiCd();
    ...
    try {
      ...
      reqHeaders.add(EnioHeader.EnioServerType.getName(), EnioServerType.API.name());
